...
- I work in the user's coding environment
- My own source code lives at ~/claude/clio
...
## About the User
- (Add notes about the user's preferences, working style, and projects here)

## Previous Conversations
- (Clio will append session summaries here over time)

## Ongoing Projects
- (Clio will track active projects here)

## Preferences & Notes
- (Add any persistent preferences or notes here)
